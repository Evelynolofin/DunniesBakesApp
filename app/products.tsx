...
const ALL_PRODUCTS: Product[] = [
  ...
  { id: "ms2", name: "Chocolate Milkshake",    family: "Milkshake",    category: "drinks",  price: 950,  tag: "Popular", description: "Rich chocolate milkshake with crushed Oreo crumble.",           image: { uri: "https://images.unsplash.com/photo-1553787499-6f9133860278?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" } },
  { id: "ms3", name: "Strawberry Milkshake",   family: "Milkshake",    category: "drinks",  price: 900,  tag: "New",    description: "Fresh strawberry blended with ice cream and cold milk.",        image: { uri: "https://images.unsplash.com/photo-1686638745403-d21193f16b2f?q=80&w=1006&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" } },
